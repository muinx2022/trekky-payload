...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'moderator', 'user');
  CREATE TYPE "public"."enum_users_oauth_provider" AS ENUM('google', 'github', 'facebook');
  CREATE TYPE "public"."enum_votes_target_type" AS ENUM('post', 'comment');
  ...
  ALTER TABLE "communities" ADD CONSTRAINT "communities_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "reddit_posts" ADD CONSTRAINT "reddit_posts_gallery_id_galleries_id_fk" FOREIGN KEY ("gallery_id") REFERENCES "public"."galleries"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "reddit_posts" ADD CONSTRAINT "reddit_posts_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "reddit_posts" ADD CONSTRAINT "reddit_posts_author_id_users_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "comments" ADD CONSTRAINT "comments_post_id_reddit_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."reddit_posts"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "votes" ADD CONSTRAINT "votes_post_id_reddit_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."reddit_posts"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_reddit_posts_fk" FOREIGN KEY ("reddit_posts_id") REFERENCES "public"."reddit_posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "users_oauth_id_idx" ON "users" USING btree ("oauth_id");
  CREATE INDEX "users_updated_at_idx" ON "users" USING btree ("updated_at");
  CREATE INDEX "users_created_at_idx" ON "users" USING btree ("created_at");
  CREATE UNIQUE INDEX "users_email_idx" ON "users" USING btree ("email");
  CREATE UNIQUE INDEX "communities_name_idx" ON "communities" USING btree ("name");
  CREATE UNIQUE INDEX "communities_slug_idx" ON "communities" USING btree ("slug");
  CREATE INDEX "communities_created_by_idx" ON "communities" USING btree ("created_by_id");
  ...
  CREATE INDEX "reddit_posts_title_idx" ON "reddit_posts" USING btree ("title");
  CREATE UNIQUE INDEX "reddit_posts_slug_idx" ON "reddit_posts" USING btree ("slug");
  CREATE INDEX "reddit_posts_gallery_idx" ON "reddit_posts" USING btree ("gallery_id");
  CREATE INDEX "reddit_posts_community_idx" ON "reddit_posts" USING btree ("community_id");
  CREATE INDEX "reddit_posts_author_idx" ON "reddit_posts" USING btree ("author_id");
  CREATE INDEX "reddit_posts_updated_at_idx" ON "reddit_posts" USING btree ("updated_at");
  CREATE INDEX "reddit_posts_created_at_idx" ON "reddit_posts" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_reddit_posts_id_idx" ON "payload_locked_documents_rels" USING btree ("reddit_posts_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "reddit_posts" CASCADE;
