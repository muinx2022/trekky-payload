...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'reddit-posts': RedditPostsSelect<false> | RedditPostsSelect<true>;
...
export interface User {
  ...
  /**
   * OAuth provider dùng để tạo tài khoản
   */
  oauthProvider?: ('google' | 'github' | 'facebook') | null;
  /**
   * Provider user ID
   */
  oauthId?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "reddit-posts".
 */
export interface RedditPost {
  ...
  content?: string | null;
  /**
   * Gallery ảnh/video của bài viết.
   */
  gallery?: (number | null) | Gallery;
  /**
   * Dùng nội bộ — danh sách media ID để tạo/cập nhật gallery.
   */
  galleryItems?:
    | {
        [k: string]: unknown;
  ...
  author: number | User;
  /**
   * Ẩn bài viết khỏi các feed công khai.
   */
  hidden?: boolean | null;
  upvotes?: number | null;
...
export interface Gallery {
  id: number;
  /**
   * Danh sách ảnh/video trong gallery.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "reddit-posts_select".
 */
export interface RedditPostsSelect<T extends boolean = true> {
  title?: T;
  generateSlug?: T;
  slug?: T;
  content?: T;
